					...
					<div className="postCard">
						<Card border="success" style={{ width: "18rem" }}>
							...
							<Card.Body>
								...
								<Button variant="primary" onClick={() => this.props.handleToUpdate("Current post", elements[i].publication_id)}>
									View
								</Button>
							</Card.Body>
						</Card>
	...
	render() {
		return (
			<Container id="Table" fluid>
				<button className="btn btn-outline-success iNeedMoreMargins" onClick={this.handleSubmit}>
					Refresh
				</button>
